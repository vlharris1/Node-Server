...
const server = http.createServer((req, res)=> {
    ...
    let welcomePage = "<html><body><h1>Welcome</h1><br><h2>Introduction to Pawpaw Fruit</h2><br><p>A Native Virginia Fruit</p></body></html> <img src=https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Asimina_triloba3.jpg/220px-Asimina_triloba3.jpg>"
...
//creating an endpoint that fetches API data
    if(url === '/list') {
